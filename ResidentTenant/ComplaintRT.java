 ...
 * @author Hong Shen
 */
public class ComplaintRT extends LoginRT{
    ...
    ArrayList<ComplaintRT> complaint = new ArrayList<>();

    public ComplaintRT() {
        super();
    }

    public ComplaintRT(String complaintID, String id, LocalDate date, String complaintType, String complaintDetail, String complaintStatus) {
        super();
    ...
    public void runComplaint() {
        ...
        do {
            ...
            switch (choice) {
                case 1 -> {
                    ComplaintRT add = new ComplaintRT();
                    add.addComplaint();
                }
                case 2 -> {
                    ComplaintRT view = new ComplaintRT();
                    view.viewComplaint();
                }
                case 3 -> {
                    ComplaintRT update = new ComplaintRT();
                    update.updateComplaint();
                }
                case 4 ->{
                    ComplaintRT delete = new ComplaintRT();
    ...
    public void newComplaint() {
        ...
        id = checkId;
        System.out.println("Enter date of complaint (yyyy-MM-dd): ");
    ...
    public void addComplaint() {
        try {
            try (Scanner scan = new Scanner(new File(FILE_NAME5))) {
                ...
                while (scan.hasNextLine()) {
                    ...
                    String[] parts = line.split("\\|");
                    ComplaintRT newC = new ComplaintRT();
                    if (parts.length >= 6) {
        ...
        ComplaintRT newC2 = new ComplaintRT();
        newC2.newComplaint();
        complaint.add(newC2);

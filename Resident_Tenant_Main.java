...
public class Resident_Tenant_Main {
    ...
    public static void main(String arg[]){
        ...
        do{
            ...
            switch (choice) {
                case 1 -> {
                    Resident_Tenant add=new Resident_Tenant();
                    add.addResident();
                ...
                case 2 -> {
                    Resident_Tenant edit=new Resident_Tenant();
                    edit.editResident();
                ...
                case 3 -> {
                    Resident_Tenant searchRT=new Resident_Tenant();
                ...
                case 4 -> {
                    Resident_Tenant view=new Resident_Tenant();
                    view.viewResident();
